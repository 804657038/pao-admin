<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"F:\wamp\www\yjnh\public/../app/admin\view\member\create.html";i:1512447018;s:60:"F:\wamp\www\yjnh\public/../app/admin\view\common\common.html";i:1512367574;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <script>
        ...
        layui.use(['form', 'layer','upload'], function () {
            ...
            form.on('submit(add)', function(data){
                ...
                $.post("<?php echo url('member/save'); ?>", data.field, function (res) {
                    if (res.code > 0) {
