<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"/Users/Web/archie/yajienh/public/../app/admin/view/set/index.html";i:1512799996;s:69:"/Users/Web/archie/yajienh/public/../app/admin/view/common/common.html";i:1512703227;s:66:"/Users/Web/archie/yajienh/public/../app/admin/view/common/nav.html";i:1512703227;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-tab">
            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    <blockquote class="layui-elem-quote">设置内容</blockquote>
                    <form class="layui-form" action="">
                        <input class="layui-input" type="hidden" name="__token__" value="<?php echo $token; ?>">
                        <div class="layui-form-item">
                            <label class="layui-form-label">红包金额设置</label>
