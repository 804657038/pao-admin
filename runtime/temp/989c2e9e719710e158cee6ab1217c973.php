<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"/Users/Web/archie/yajienh/public/../app/admin/view/user/create.html";i:1512703227;s:69:"/Users/Web/archie/yajienh/public/../app/admin/view/common/common.html";i:1512703227;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="x-body">
        <form action="" method="post" class="layui-form layui-form-pane">
            ...
            <div class="layui-form-item">
                ...
                <input type="hidden" name="image" id="logo" value="<?php echo $image; ?>">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <div class="layui-input-inline">
                        <input type="text" id="name" value="<?php echo $data['username']; ?>" name="username" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <div class="layui-input-inline">
                        <input type="text" value="<?php echo $data['phone']; ?>" name="phone" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div style="line-height: 38px">
                    <input style="margin-left: 12px" lay-ignore type="radio" value="1" name="sex" autocomplete="off"  <?php if($data['sex'] == '男'): ?>checked<?php endif; ?> >男
                    <input style="margin-left: 12px" lay-ignore type="radio" value="0" name="sex" autocomplete="off"  <?php if($data['sex'] == '女'): ?>checked<?php endif; ?> >女
                    <input style="margin-left: 12px" lay-ignore type="radio" value="2" name="sex" autocomplete="off"  <?php if($data['sex'] == '保密'): ?>checked<?php endif; ?> >保密
                </div>
            </div>
            <div class="layui-form-item">
                <label for="name" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <div class="layui-input-inline">
                        <input type="text" value="<?php echo $data['store_name']; ?>" name="store_name" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="province" onchange="loadRegion('province',2,'city','<?php echo url('getAddrs'); ?>','')" id="province" lay-ignore style="height: 38px;float: left;margin-right: 10px;border-color: #D2D2D2!important;">
                        ...
                        <option <?php if($data['province'] == $vo['name']): ?>selected="selected"<?php endif; ?> value="<?php echo $vo['id']; ?>" ><?php echo $vo['name']; ?></option>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <div class="layui-input-inline">
                        <input type="text" value="<?php echo $data['addr']; ?>" name="addr" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        var ct = "<?php echo $city; ?>";
        var dt = "<?php echo $area; ?>";
        ...
        layui.use(['form', 'layer','upload'], function () {
            ...
            if("<?php echo $image; ?>"){
                cltLogo.src = "__ROOT__"+"<?php echo $image; ?>";
            }
            //普通图片上传
            ...
            form.on('submit(add)', function(data){
                ...
                $.post("<?php echo url('user/save'); ?>", data.field, function (res) {
                    if (res.code > 0) {
