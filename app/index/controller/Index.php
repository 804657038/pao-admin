...
//            if($MC>=1)return json(['code' => 0, 'msg' => '感谢您对诗尼曼家居的关注<br/>本活动限参与1次哦~']);
            ...
            $group = 0;
            $record = 0;
            $MC=$redList->where('user_id',UID)->where('add_time','>=',$toDay)->field('record')->find();
            if($gameTime['one_start'] <= $nowTime && $nowTime <= $gameTime['one_end']){
                ...
                if($time1 >= 1){
                    $g1 = db('red_list')->where('group',1)->count();
                    if($g1<1){
                        $money = 188;
                        $group = 1;
                    }
                ...
                if($time2 <= 10){
                    $g2 = db('red_list')->where('group',2)->count();
                    if($g2<1){
                        $money = 188;
                        $group = 2;
                    }
                ...
                if($time3 >= 1){
                    $g3 = db('red_list')->where('group',3)->count();
                    if($g3<1){
                        $money = 188;
                        $group = 3;
                    }
                ...
                if($time4 <= 10){
                    $g4 = db('red_list')->where('group',4)->count();
                    if($g4<1){
                        $money = 188;
                        $group = 4;
                    }
                ...
                if($time5 >= 1){
                    $g5 = db('red_list')->where('group',5)->count();
                    if($g5<1){
                        $money = 188;
                        $group = 5;
                    }
                ...
                if($time6 <= 10){
                    $g6 = db('red_list')->where('group',6)->count();
                    if($g6<1){
                        $money = 188;
                        $group = 6;
                    }
                ...
                if($time7 >= 1){
                    $g7 = db('red_list')->where('group',7)->count();
                    if($g7<1){
                        $money = 188;
                        $group = 7;
                    }
                ...
                if($time8 <= 10){
                    $g8 = db('red_list')->where('group',8)->count();
                    if($g8<1){
                        $money = 188;
                        $group = 8;
                    }
